    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-120px)] relative z-10">
        <motion.div 
          ...
          className="w-full max-w-md bg-white/95 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/20"
        >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" title="Forgot Password?" className="text-sm text-blue-600 font-bold hover:underline">
              Forgot Password?
            </Link>
          </div>
