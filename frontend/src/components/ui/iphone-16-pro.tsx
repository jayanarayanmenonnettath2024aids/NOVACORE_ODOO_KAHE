import { type SVGProps, forwardRef, type CSSProperties } from "react";
            ...
            >
                ...
                {children && (
                    <foreignObject
                        ...
                        clipPath="url(#screen)"
                    >
                        <div className={`w-full h-full bg-white relative overflow-hidden rounded-[${screenRadius}px] ${contentClassName || ''}`} style={contentStyle}>
                            {children}
                        </div>
                    </foreignObject>
                )}
